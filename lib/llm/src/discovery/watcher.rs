...
impl ModelWatcher {
    ...
    /// Watch for model changes but only process models from a specific namespace
    pub async fn watch_namespace_filtered(&self, mut events_rx: Receiver<WatchEvent>, target_namespace: &str) {
